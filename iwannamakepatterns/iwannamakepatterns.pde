...
void draw() {
  ...
  switch(Mode){//why the dingus does processing autoformat the switch case to be so hard to read? do people actually write them that way?
  case 0://rectanglopulous; SV1 = number of rects per ring, SV2 = number of rings
